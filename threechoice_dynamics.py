#diseased and healthy dynamics gradients for a PD-like beta oscillation dynamical system
...
def grad_threechoice(V,n,dt,Control):
    ...
    #transform from -100 to 20 to jive with original Izhikevich form
    Vold = V
    V = 180.*V-80.
    ...
    #threshold linear exponential for stability
    emaxarg = 10.
